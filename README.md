...
## Included Device Trees

This repository includes device-specific configurations:

1. **Motorola Moto G - 2025 (Kansas)** - Android 15 device tree in `motorola/kansas/`
   - See [motorola/BUILD_INSTRUCTIONS.md](motorola/BUILD_INSTRUCTIONS.md) for building instructions
...
| `DEVICE_TREE_URL`    | Device address (leave blank for local tree)       | https://github.com/TeamWin/android_device_asus_I003D         |
...
### Example: Building for Motorola Moto G - 2025 (Kansas)

For the included Motorola Kansas device (Android 15), use these parameters:
